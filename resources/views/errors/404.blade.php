...
<head>
	<title>404 Page Not Found | Kingboard - Admin Dashboard</title>
	<meta charset="utf-8">
		...
		<div class="inner-page">
			<h1>
				<span class="clearfix title">
					...
					<span class="text">Sayfa Bulunamadı!</span>
				</span>
			</h1>

			<p>Lütfen uygulamayı kullanırken menü seçeneklerini kullanınız.</p>

			<p>
				<a href="javascript:history.go(-1)" class="btn btn-custom-primary"><i class="fa fa-arrow-left"></i> Geri</a>

			</p>
		</div>

		<footer class="footer">&copy; {{ date('Y') }} Aragonit Bilgi Teknolojileri</footer>
	</div>
