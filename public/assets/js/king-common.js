$(document).ready(function(){
	...
	$('.main-menu .js-sub-menu-toggle').click( function(e){
        ...
        $('.js-sub-1-menu-toggle').click( function(e){

		e.preventDefault();

		$li = $(this).parents('li');
		if( !$li.hasClass('active')){
			$li.find('.toggle-icon-1').removeClass('fa-angle-left').addClass('fa-angle-down');
			$li.addClass('active');
		}
		else {
			$li.find('.toggle-icon-1').removeClass('fa-angle-down').addClass('fa-angle-left');
			$li.removeClass('active');
		} 
	
		$li.find('.sub-1-menu').slideToggle(300);
	});
        $('.js-sub-2-menu-toggle').click( function(e){

		e.preventDefault();

		$li = $(this).parents('li');
		if( !$li.hasClass('active')){
			$li.find('.toggle-icon-2').removeClass('fa-angle-left').addClass('fa-angle-down');
			$li.addClass('active');
		}
		else {
			$li.find('.toggle-icon-2').removeClass('fa-angle-down').addClass('fa-angle-left');
			$li.removeClass('active');
		} 
	
		$li.find('.sub-2-menu').slideToggle(300);
	});
        $('.js-sub-3-menu-toggle').click( function(e){
		...
		if( !$li.hasClass('active')){
			...
			$li.find('.toggle-icon-3').removeClass('fa-angle-down').addClass('fa-angle-left');
			$li.removeClass('active');
		} 
	
		$li.find('.sub-3-menu').slideToggle(300);
	});
